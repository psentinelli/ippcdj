...
from schedule.views import DeleteEventView,calendar_by_year,calendar,api_occurrences,edit_occurrence,cancel_occurrence,event,calendar_by_periods,occurrence,create_or_edit_event
