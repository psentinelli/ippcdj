...
class Event(models.Model):
    ...
    creator = models.ForeignKey(User, null=True, blank=True, verbose_name=_("creator"),
                                related_name='creator',on_delete=models.DO_NOTHING,)
    created_on = models.DateTimeField(_("created on"), auto_now_add=True)
    updated_on = models.DateTimeField(_("updated on"), auto_now=True)
    rule = models.ForeignKey(Rule,on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("rule"),
    ...
    calendar = models.ForeignKey(Calendar,on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("calendar"))
    ...
    country = models.ForeignKey(CountryPage,on_delete=models.DO_NOTHING, related_name="event_country_page", default=-1)
...
class EventFile(models.Model):
    event = models.ForeignKey(Event,on_delete=models.DO_NOTHING, verbose_name=_("event"))
...
class EventParticipants(models.Model):
    ...
    representing_organization = models.ForeignKey(PartnersPage,on_delete=models.DO_NOTHING,  verbose_name=_("Representing Organization"), blank=True, null=True)
...
class EventRelation(models.Model):
    ...
    '''
    event = models.ForeignKey(Event, verbose_name=_("event"),on_delete=models.DO_NOTHING,)
